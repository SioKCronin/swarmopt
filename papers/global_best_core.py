...
algo = global_best_pso

def run_20(n, dims, c1, c2, w, iters, obj_func, val_min, val_max):
    '''
...
def run_all_tests(obj_func, val_min, val_max):
    ...
    print("Single run test:", algo(n, 2, c1, c2, w, iters, obj_func,\
                                                   val_min, val_max))
    print("Run 20:", run_20(n, 2, c1, c2, w, iters, obj_func, val_min, val_max))
