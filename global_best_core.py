...
# Run Global Best PSO 20 times on each function and take an average

def run_20(n, dims, c1, c2, w, iters, obj_func):
    '''
    ...
    vals = []
    for i in range(20):
        vals.append(global_best_pso(n, dims, c1, c2, w, iters, obj_func))
...
print(global_best_pso(n, dims, c1, c2, w, iters, obj_func))
run_20(n, dims, c1, c2, w, iters, obj_func)
